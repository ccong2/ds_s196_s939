...
After completing the map, you can compare it with the [Map 2] we made in the lab. How does it relate to the demographic trends and socio-economic factors in the resources you've reviewed? What insights might this add to your understanding of the city?

2.  Use two years of historical LTDB population data **(1970 and 2020)** to calculate the percentage increase in population for tracts in **Cook County**. Create one [Map 2] type graph to visualize census tracts that have shown significant increasing and decreasing trends over the past five decades.
