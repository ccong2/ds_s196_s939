...
How many of these eligible census tracts are designated as Opportunity Zones? Are there any distinguishable differences in economic conditions between designated and not designated census tracts? Look back on our questions when we started and discuss what you have found so far, with a focus on Massachusetts. Make sure to include the required graph, along with any supplementary materials if this helps to convey your conclusions. Talk about any specific aspects you would like to further investigate on this question.
